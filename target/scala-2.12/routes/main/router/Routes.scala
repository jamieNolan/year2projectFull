...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """facebook""", """controllers.HomeController.facebook"""),
  ...
  // @LINE:53
  private[this] lazy val controllers_HomeController_facebook38_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("facebook")))
  )
  private[this] lazy val controllers_HomeController_facebook38_invoker = createInvoker(
    HomeController_1.facebook,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "facebook",
  ...
  // @LINE:54
  private[this] lazy val controllers_HomeController_twitter39_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("twitter")))
  )
  private[this] lazy val controllers_HomeController_twitter39_invoker = createInvoker(
    HomeController_1.twitter,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "twitter",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:53
    case controllers_HomeController_facebook38_route(params@_) =>
      call { 
        controllers_HomeController_facebook38_invoker.call(HomeController_1.facebook)
      }
  
    // @LINE:54
    case controllers_HomeController_twitter39_route(params@_) =>
      call { 
        controllers_HomeController_twitter39_invoker.call(HomeController_1.twitter)
      }
  }
}
